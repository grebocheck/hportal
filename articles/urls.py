...
urlpatterns = [
    path("", views.index),
    path("articles/", views.articles_list, name="article.articles"),
    ...
    path("article/<slug:slug>", views.articleDetail, name="article.article_detail"),
    ...
    # Review
    path("article/review/<int:pk>/edit", views.ReviewUpdateView.as_view(), name="article.review_update"),
